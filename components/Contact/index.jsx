    ...
    <>
      ...
      >
        <div className="flex flex-col justify-center items-center h-[55vh] lg:w-[1240px] 2xl:w-[1900px]">
          <h1 className="text-white font-PTGilroy-Bold text-2xl  lg:text-3xl w-full text-center mb-2">
            {" "}
          ...
          <div className="lg:flex items-center justify-evenly w-[60%] mt-7 hidden">
            ...
            <Link href="https://www.facebook.com/GDGAlgiers">
              <Image
                alt="Facebook Icone"
                src={Facebook}
                className="cursor-pointer w-[53px] h-[49px] "
              ></Image>
            </Link>
          ...
          <Image
            alt="UnderIcones"
            src={Under}
            className="lg:translate-x-[10px] w-[60%] hidden lg:block"
          ></Image>
          <div className="lg:hidden  flex items-center justify-evenly w-full mt-12 ">
            <Link href="https://twitter.com/GDG_Algiers">
              <Image
                alt="Twitter Icone"
                src={Twitter}
                className="cursor-pointer w-[46px]"
              ></Image>
            </Link>
            <Link href="https://www.facebook.com/GDGAlgiers">
              <Image
          ...
          <Image
            alt="UnderIcones"
            src={UnderR}
            className="translate-x-[-15px] block lg:hidden"
          ></Image>
