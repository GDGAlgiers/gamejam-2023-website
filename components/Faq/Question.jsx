...
const Question=({question,answer})=>{
    ...
    return(
        <div className="flex flex-col items-center justify-center w-[300px] sm:w-[400px] md:w-[500px] lg:w-[600px] 2xl:w-[1080px] font-PTGilroy-Light transition-all duration-100">
                ...
                <p className={`z-[9999] w-full ${clicked ? 'opacity-100 max-h-[100%]' : 'opacity-0 max-h-0'} px-4 m-0 mt-0 mb-0 transition-all duration-300 self-start justify-self-start text-[8px] md:text-[12px] lg:text-[14px] 2xl:text-xl font-PTGilroy-Bold text-white my-2`}>{answer}</p>
        </div>
    )
}
...
const Question2=({question,answer})=>{
    return(
            <> 
                    <p className={`z-[9999] w-full ${clicked ? 'opacity-100 bg-red-200 bg-opacity-20 max-h-[100%] h-[100%] pb-0 ' : 'opacity-0 max-h-0 h-0 pb-0'} m-0 mt-0 mb-0 transition-all duration-500 self-start justify-self-start text-[8px] md:text-[12px] lg:text-[14px] 2xl:text-xl font-PTGilroy-Bold text-white my-2`}>{answer}</p>
            </>
