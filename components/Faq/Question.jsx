...
const Question=({question,answer})=>{
    ...
    return(
        ...
        <div className="lg:hidden my-2 flex flex-col items-center justify-center font-PTChaser-Light w-full">
            <div className="text-[8px] font-PTGilroy-Bold text-[#4EFEF6] w-[90%] flex items-center justify-between px-3 py-1 bg-[url('/images/FaqImages/FaqBg.png')] bg-contain bg-no-repeat" >
        ...
        <div className="hidden flex flex-col items-center justify-center 2xl:block my-2 w-[1080px] font-PTGilroy-Light">
        ...
        <div className="hidden flex flex-col items-center justify-center lg:block 2xl:hidden my-2 w-[720px] font-PTChaser">
